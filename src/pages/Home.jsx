...
const Home = () => {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'مدقق الأمتعة - أداة مجانية شاملة للتحقق من سياسات أمتعة أكثر من 100 شركة طيران عالمية. احسب نتيجة حقيبتك واحصل على توصيات ذكية قبل السفر.');
    }
  }, []);
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center slide-in">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed" itemProp="description">
              تحقق من سياسات الأمتعة لأكثر من 100 شركة طيران عالمية في ثوانٍ معدودة. احسب نتيجة حقيبتك واحصل على توصيات ذكية.
            </p>
          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "ابحث عن شركة الطيران، أدخل أبعاد ووزن حقيبتك، واحصل على نتيجة رقمية مع توصيات ذكية حول سياسات الأمتعة."
              }
            },
            {
              "@type": "Question",
